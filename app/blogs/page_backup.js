            ...
            {blogs && blogs.length > 0 ? (
              currentBlogs.length > 0 ? (
                currentBlogs.map((blog, index) => {
                  ...
                  // Enhanced gradient palette with yellow/golden theme
                  const gradients = [
                    'linear-gradient(135deg, #fefce8 0%, #fef3c7 50%, #fde68a 100%)', // yellow
                    'linear-gradient(135deg, #fff7ed 0%, #ffedd5 50%, #fed7aa 100%)', // amber light
                    'linear-gradient(135deg, #fef7f0 0%, #fed7aa 50%, #fdba74 100%)', // golden
                    'linear-gradient(135deg, #fffbeb 0%, #fef3c7 50%, #fbbf24 100%)', // warm yellow
                    'linear-gradient(135deg, #fff8f1 0%, #ffead5 50%, #fdd5b0 100%)', // peach
                    'linear-gradient(135deg, #fefce8 0%, #fef9c3 50%, #facc15 100%)', // bright yellow
                  ];
